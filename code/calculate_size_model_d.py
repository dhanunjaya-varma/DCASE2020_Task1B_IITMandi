...
model1 = models.load_model('/home/dhanunjaya/Documents/final/model_d/model10.h5py')
model2 = models.load_model('/home/dhanunjaya/Documents/final/model_d/best_model_soundnet_fc_64_No_32.h5py')
first_model = model1.layers[12].output
second_model = model2.layers[9].output
model3 = models.load_model('/home/dhanunjaya/Documents/final/model_d/best_weights_early_fusion_soundnet.h5py')
concatenated = layers.concatenate([first_model, second_model], axis=-1)
concatenated = Model([model1.input, model2.input], concatenated)
model = Model(concatenated.input, model3(concatenated.output))
model.compile(loss=keras.losses.categorical_crossentropy,optimizer=keras.optimizers.Adam(),metrics=['accuracy'])

print("Model D")
get_keras_model_size(model)
