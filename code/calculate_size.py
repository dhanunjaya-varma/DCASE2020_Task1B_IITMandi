...
print("Model A")
get_keras_model_size(models.load_model('/home/dhanunjaya/Documents/final/model_a/best_Model_gap_91k_fc32_retrain.h5py'))

print("Model B")
get_keras_model_size(models.load_model('/home/dhanunjaya/Documents/final/model_b/best_weights_soundnet.h5py'))

print("Model C")
get_keras_model_size(models.load_model('/home/dhanunjaya/Documents/final/model_c/best_model_soundnet_fc_64_No_32.h5py'))