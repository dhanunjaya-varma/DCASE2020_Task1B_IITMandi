...
csvfile = open('/users/home/s18023/DCASE2020/taskb/final/model_b/evaluation_model_b.csv','w', newline='')
obj = csv.writer(csvfile, delimiter='\t')
obj.writerow(header)

fs=2000

model = models.load_model('/users/home/s18023/DCASE2020/taskb/final/model_b/model.h5py')
