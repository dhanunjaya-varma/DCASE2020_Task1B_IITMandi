...
csvfile = open('/users/home/s18023/DCASE2020/taskb/final/model_a/evaluation_model_a.csv','w', newline='')
obj = csv.writer(csvfile, delimiter='\t')
obj.writerow(header)

fs=2000

model = models.load_model('/users/home/s18023/DCASE2020/taskb/final/model_a/model.h5py')
#model = models.load_model('/users/home/s18023/DCASE2020/taskb/fold1/best_Model_gap_50k_retrain.h5py')
#model = models.load_model('/users/home/s18023/DCASE2020/taskb/models/best_Model_gap_100k.h5py')
#model = models.load_model('/users/home/s18023/DCASE2020/taskb/models/best_weights_soundnet.h5py')
